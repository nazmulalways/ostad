                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="number1" class="form-control" placeholder="ex: 40" required
                                        value="<?= isset($number1)?$number1:''; ?>">
                                </div>
                                <div class="mb-3">
                                    <label>Enter your second number</label>
                                    <input type="text" name="number2" class="form-control" placeholder="ex: 80" required
                                        value="<?= isset($number2)?$number2:''; ?>">
                                </div>
                            </div>
